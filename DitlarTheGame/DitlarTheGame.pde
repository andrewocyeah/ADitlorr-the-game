...
boolean shoppush;//for the-involutary-spam bug
int place = 0;
...
void draw(){
  if(mode==0){//overworld map
    ...
    if(menu==0){
      ...
      rect(x,y,20,20);
      fill(255);
      rect(x-(width/2),y-(height/2),100,20);
      fill(0,255,0,100);
      rect(x-(width/2),y-(height/2),map(money,0,moneymax,0,100),20);
      textSize(20);
      fill(0);
      text(money,x-(width/2)+50,y-(height/2)+15);
      fill(255);
      rect(x-(width/2),y-(height/2)+20,100,20);
      fill(255,255,0,100);
      rect(x-(width/2),y-(height/2)+20,map(energypoints,0,energypointsmax,0,100),20);
      textSize(20);
      fill(0);
      text(energypoints,x-(width/2)+50,y-(height/2)+35);
